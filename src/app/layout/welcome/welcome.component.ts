...
export class WelcomeComponent implements OnInit{
  ...
  constructor(private backendService: BackendService){
    ...
    this.kycForm = new FormGroup({
      ...
      proofOfIdentity: new FormControl('', [Validators.required]),
      ...
      permanentZip: new FormControl('', [Validators.required]),
      permanentCountry: new FormControl('', [Validators.required]),
      permanentProofOfAddress: new FormControl('', [Validators.required]),
      proofFile: new FormControl('', [Validators.required]),
  ...
  onSubmit(e: any){
    this.backendService.makeHttpCallstoLoremIpsum().subscribe((data) => {
      this.bakeSome = data;
    })
  }
}
